...
## Step 1: <small>_Selecting an IDE and Framework_</small>
...
## Step 2: <small>_Connecting Your Wallet_</small>
...
## Step 3: <small>_Selecting a Network_</small>
...
## Step 4: <small>_Writing a Smart Contract_</small>
...
## Step 5: <small>_Covering Deployment Costs (Gas)_</small>
...
## Step 6: <small>_Verifying Your Deployment_</small>
...
## Step 7: <small>_Interacting with Deployed Contracts_</small>
...
## Step 8: <small>_Viewing your Deployed Contracts_</small>

The Bitfinity block explorer, and other explorers, allows you to view the deployed contracts on a specific address.
