...
Black IDE is a multi-platform graphic IDE for smart contract development on EVMC, Ethereum and EVM-compatible blockchains.
...
With built-in connections to EVMC mainnet and testnet, developers can now easily deploy smart contract projects to EVMC directly from Black IDE.
